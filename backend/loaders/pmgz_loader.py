...
DE_PARA_PMGZ_COMPLETO = {
    ...
    "ANIMAL_RAÇA": "identificacao_animal_raca",
    "ANIMAL_RACA": "identificacao_animal_raca",
    "RAÇA": "identificacao_animal_raca",
    "RACA": "identificacao_animal_raca",
    "ANIMAL_CC": "identificacao_animal_raca",
    "CC": "identificacao_animal_raca",
...
class PMGZLoader(BaseLoader):
    ...
    def para_colunas_banco(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        mapa = {
            ...
            'identificacao_animal_raca': 'raca',
